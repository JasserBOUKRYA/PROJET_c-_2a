...
void Dialog::on_pb_ajouter1_clicked()
{
    son->play();
...
void Dialog::on_pb_tri_dest_clicked()
{
    son->play();
...
void Dialog::on_tab_dechet_activated(const QModelIndex &index)
{
...
/*void Dialog::on_tabWidget2_currentChanged(int index)
{
    if (index==1)
    ui->tab_dechet->setModel(D1.afficher());
}*/
