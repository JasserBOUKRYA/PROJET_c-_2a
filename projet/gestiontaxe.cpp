...
void Dialog::on_le_recherche_2_textChanged(const QString &arg1)
{
    Taxe T;
...
void Dialog::on_button_tri1_clicked()
{
    son->play();
...
void Dialog::on_modifiertaxe_clicked()
{
    son->play();
